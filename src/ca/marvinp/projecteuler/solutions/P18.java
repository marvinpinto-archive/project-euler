...
public class P18 {
  ...
  private int[][] loadMatrix() {
    ...
    try {
      InputStream is = P18.class.getClassLoader()
        .getResourceAsStream(Constants.INPUT_PATH + "p18.txt");
  ...
  public String getQuestion() {
    StringBuilder sb = new StringBuilder();
    sb.append("URL: https://projecteuler.net/problem=18" + Constants.NEWLINE);
